...
export const config = {
  ...
  matcher: [
    '/((?!login|explore|api/auth|api/explore|api/feedback|api/stripe/webhook|api/worlds/[^/]+/public|_next/static|_next/image|favicon\\.svg|conjured/|catalog/|sky/|fonts/|avatars/|models/).*)',
  ],
}
